...
#Lo que he hecho a sido meter todo dentro de un DEF y ahi dentro meter todo el codigo con tal de que si quieres repetir la misma operacion solo pones el def y ya
def Trabajo():
    if opcion == "1":
